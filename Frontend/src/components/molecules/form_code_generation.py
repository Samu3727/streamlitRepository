...
def CodeGenerationForm():
    ...
    user_story = SelectBox("Historia de Usuario:", ["Historia 1", "Historia 2", "Historia 3"], key="cg_user_story")
    github_url = st.text_input("Url Proyecto Github:", placeholder="https://github.com/davivienda-example/DevMau")
    technology = SelectBox("Tecnología:", ["Python", "Node.js", "Java", "Ruby"], key="cg_technology")

    if st.button("Enviar", key="submit_code_generation"):
